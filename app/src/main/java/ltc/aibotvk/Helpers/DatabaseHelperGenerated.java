...
public class DatabaseHelperGenerated extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Generated.db";
    public static final String TABLE_NAME = "generated_table";
    public static final String COL_1 = "ID";
    public static final String COL_2 = "SENTENCE";
    public static final String COL_3 = "ANSWER";

    public DatabaseHelperGenerated(Context context) {
        super(context, DATABASE_NAME, null, 1);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,SENTENCE TEXT,ANSWER TEXT,RATING INTEGER)");
    }
